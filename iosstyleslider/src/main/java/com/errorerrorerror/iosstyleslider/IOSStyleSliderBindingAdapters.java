...
@BindingMethods({
        @BindingMethod(type = IOSStyleSlider.class,
                attribute = "android:enabled", method = "setOnSliderEnabledChangeListeners")}
)
...
public class IOSStyleSliderBindingAdapters {
    ...
    @BindingAdapter(value = {"text", "issTextAttrChanged"})
    ...
    @BindingAdapter(value = {"android:enabled", "issSliderEnabledAttrChanged"},
            requireAll = false)
